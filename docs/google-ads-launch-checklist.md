# Google Ads launch checklist â€” OmniTender

---

## Status (2026-07-13)

**Campaign:** Omnitender Search — **submitted**, awaiting Google review.  
**Budget:** $10/day custom. Final URL: `https://omnitender.us/savings.html`.  
**Still open:** GA4 `gaMeasurementId` in `site-config.js` (wire after property created); conversion action `generate_lead` once GA4 live.
...
1. **GA4 measurement ID** in `site-config.js` â†’ `gaMeasurementId: 'G-XXXXXXXXXX'`
2. **Site deployed** with `google-analytics.js` + `conversion-events.js` on all pages
3. **Test form** on savings.html â†’ you receive alert (OmniVerse webhook)
...
| Networks | **Search only** â€” uncheck Display, uncheck Search partners initially |
...
| Ad schedule | All day (optional: Monâ€“Sat 6amâ€“10pm later) |

---

## Keywords (Phrase match â€” add with quotes)
...
Tired of hidden batch fees and PCI charges? We'll show you the real numbers â€” no pressure.
Western NC merchants â€” call (828) 413-0859 or request analysis online. Local team, not a call center.
```
...
**Live (page load):** lead forms â†’ `https://omnitender.us/thanks.html`  
Snippets (live + parked click variant): [`google-ads-conversion-snippets.md`](./google-ads-conversion-snippets.md)

1. **Goals â†’ Conversions â†’ New conversion action**
2. Choose **Website**
...
| Day 3 | Search terms report â†’ add negatives for junk |
...
If the Google UI is overwhelming: create the campaign with **one ad group, 5 keywords, 3 headlines, 2 descriptions** â€” launch imperfect, optimize later. A live $10/day campaign beats a perfect draft.
